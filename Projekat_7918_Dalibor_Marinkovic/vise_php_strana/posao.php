            ...
            <div class="main row mt-sm-5">
                <nav class="col-sm-4 d-flex justify-content-center col-12 float-sm-left">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href='ljubav.php' class='nav-link text-dark font-italic font-weight-bolder'>Ljubav</a>
                        </li>
                        <li class="nav-item">
                ...
                <section class="col-sm-8 col-12 mt-sm-5">
                    <?php
                    $lines = file("citati/posao.txt");
                    ...
                    echo "<p id='second-p' class='text-center mb-sm-5'>$autor</p>";
                    echo "<p class='text-center mb-sm-5'>$error</p>";
                    ?>
                </section>
            </div><!--end of main -->
